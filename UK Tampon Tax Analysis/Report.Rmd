...
None of the other goods appear to have had a significant change in price at the time of the tax abolition. To ensure that the estimated models are appropriate, residual graphs and ACFs are also shown.

```{r, echo=FALSE}
knitr::include_graphics("Figures/Residual_Plots.pdf")
```
