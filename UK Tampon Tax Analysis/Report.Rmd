...
Since the dependent variable was the natural log of the price index, the results can be interpreted as a roughly 4% drop in price due to the abolition of the tampon tax. To check whether the estimated model is a good fit, a plot of the residuals against the fitted values along with a plot of the ACF of the residuals are shown.

```{r Tampon Resid Graphs}
```
